...
import com.ichi2.anki.jsaddons.AddonDownloadActivity.Companion.DOWNLOAD_FILE
...
class AddonDownloadFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_addon_download, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mDownloadManager = (activity as AddonDownloadActivity).mDownloadManager
    ...
    private var mOnComplete: BroadcastReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            fun verifyDeckIsImportable() {
                ...
                if (!ImportUtils.isFileAValidTgz(mFileName)) {
                    Timber.i("File does not have 'tgz' extension, abort the extracting")
